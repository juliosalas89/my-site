...
export default function PrivacyPolicyGe () {
    return (
        <main className="privacy-policy-main">
            ...
            <h3 className="privacy-policy-subtitle">Cookies und ähnliche Technologien</h3>
            <div className="privacy-policy-content">
                <p>Unsere Anwendung verwendet keine Cookies oder ähnlichen Technologien, um Informationen von Benutzern zu sammeln.</p>
            </div>
            <h3 className="privacy-policy-subtitle">Änderungen an der Datenschutzrichtlinie</h3>
            <div className="privacy-policy-content">
                <p>Wir können diese Datenschutzrichtlinie in der Zukunft aktualisieren, um Änderungen in unseren Datensammlungs- und -nutzungspraktiken oder Änderungen in geltenden Datenschutzbestimmungen widerzuspiegeln. Wesentliche Änderungen an dieser Richtlinie werden den Benutzern über ein App-Update mitgeteilt.</p>
            </div>
            <h3 className="privacy-policy-subtitle">Kontakt</h3>
            <div className="privacy-policy-content">
                <p>Wenn Sie Fragen oder Bedenken zu unserer Datenschutzrichtlinie haben, kontaktieren Sie uns bitte unter julio.a.salas89@gmail.com, wir stehen Ihnen gerne zur Verfügung, um Ihre Anfragen zu beantworten.</p>
            </div>
            <h3 className="privacy-policy-subtitle">Einwilligungsverwaltung</h3>
            <div className="privacy-policy-content">
                <p>Wenn Sie Ihre Einwilligung ändern möchten, können Sie dies jederzeit in den Anwendungseinstellungen tun.</p>
            </div>
        </main>
    )
} 