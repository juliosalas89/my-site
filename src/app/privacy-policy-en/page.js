...
export default function PrivacyPolicyEn () {
    return (
        <main className="privacy-policy-main">
            ...
            <div className="privacy-policy-content">
                <p>Our application does not use cookies or similar technologies to collect information from users.</p>
            </div>
            <h3 className="privacy-policy-subtitle">Changes to the Privacy Policy</h3>
            <div className="privacy-policy-content">
                <p>We may update this Privacy Policy in the future to reflect changes in our data collection and usage practices or changes in applicable privacy regulations. Any significant changes to this policy will be communicated to users through an app update.</p>
            </div>
            <h3 className="privacy-policy-subtitle">Contact</h3>
            <div className="privacy-policy-content">
                <p>If you have questions or concerns about our Privacy Policy, please contact us at julio.a.salas89@gmail.com, we would be happy to address your inquiries.</p>
            </div>
            <h3 className="privacy-policy-subtitle">Manage Consent</h3>
            <div className="privacy-policy-content">
                <p>If you want to manage your consent, you can do so at any time in the application settings</p>
            </div>
        </main>
    )
} 